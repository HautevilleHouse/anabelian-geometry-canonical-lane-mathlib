# Anabelian Geometry — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/anabelian-geometry-canonical-lane-mathlib.git
cd anabelian-geometry-canonical-lane-mathlib
lake exe
lake build
```
