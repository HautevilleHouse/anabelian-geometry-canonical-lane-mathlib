...
This module internalizes the theorem-facing object for `anabelian-geometry-canonical-lane`
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate for Anabelian Geometry internalized through baseline gates, source constants, reviewer bridge, manifest hashes, outside-constant dependency count, and Mathlib-native closure layer",
